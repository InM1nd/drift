...
/**
 * 3 рядовых врага отсека «Хорда». Паттерны — простые циклы (детерминированные),
 * без взвешенного выбора — RNG здесь нужен только для тасования колоды и HP-ролла.
 * Полный ростер (+ элита/босс ниже) — docs/04-enemies.md.
 */
