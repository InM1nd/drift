...
import { getMapNodeById, DISPLAY_LAYERS } from "../data/mapNodes";
...
export function MapScreen() {
  ...
  const currentNode = getMapNodeById(currentNodeId);
        ...
        <>
          ...
          <div className="reward-grid">
            {currentNode.next.map((nextId) => {
              const next = getMapNodeById(nextId);
              return (
